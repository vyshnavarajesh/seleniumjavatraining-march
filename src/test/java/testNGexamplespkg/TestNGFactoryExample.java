...
public class TestNGFactoryExample extends BaseTest {
	...
	@Test(description = "Verification of different valid login & Password")
	public void loginToSauceDemowithDataProvider() throws InterruptedException {
		...
		driver.findElement(
				new ByAll(By.id("user-name"), By.name("user-name"), By.xpath("//input[@placeholder='Username']")))
				.sendKeys(userName);
		...
		String actualproductHeader = driver.findElement(By.xpath("//div[@data-test='secondary-header']/span"))
				.getText();
