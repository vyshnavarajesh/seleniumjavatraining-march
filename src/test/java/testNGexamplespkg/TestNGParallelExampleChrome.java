...
public class TestNGParallelExampleChrome extends BaseTestThreadLocal{
	...
	@BeforeMethod
	public void setup() {
		initializeDriver("chrome-incognito");
	...
	@DataProvider(name="invalidcredentials", parallel = true)  //JSON or csv or excel
